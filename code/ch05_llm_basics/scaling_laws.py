...
OUTPUT_PATH = Path("assets/ch05_scaling_laws.png")
...
def fit_scaling_law():
    ...
    return popt, n_fit, loss_fit


def plot_scaling_laws(output_path=OUTPUT_PATH):
    """保存 scaling laws 与涌现能力图。"""
    popt, n_fit, loss_fit = fit_scaling_law()
    ...
    ax1.loglog(
        ...
        markersize=8,
        zorder=5,
        label="Data points (Kaplan et al. 2020)",
    )
